...
/***/ function(module, exports, __webpack_require__) {
	...
	var _toolbox = __webpack_require__(4);
	...
	var Board = function () {
	  ...
	  _createClass(Board, [{
	    ...
	    value: function generateToolBox() {
	      ...
	      var toolbox = new _toolbox2.default(handles);
	    ...
	    value: function newTower(e) {
	      var tower = new _tower2.default(this.towerSize, this.update.bind(this));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Tower = function () {
	  function Tower(size, update, createProjectile) {
	  ...
	  _createClass(Tower, [{
	    ...
	    value: function targetMinion(minions) {
	      ...
	      for (var i = 0; i < minions.length; i++) {
	        var minionX = minions[i].elements.x + 15 / 2;
	        var minionY = minions[i].elements.y + 15 / 2;
	      ...
	      if (target !== null) {
	        var _minionX = target.elements.x + 15 / 2;
	        var _minionY = target.elements.y + 15 / 2;
	        this.aimTurret(_minionX, _minionY);
	        var time = new Date().getTime();
	    ...
	    key: "shootTurret",
	    value: function shootTurret(minion) {
	      var projectile = new _projectile2.default(minion, 2, 4);
	    ...
	    value: function aimTurret(x, y) {
	      ...
	      var dX = this.elements.x - x;
	      var dY = this.elements.y - y;
	
	      var angle = toDegrees(Math.atan(dY / dX));
	      angle += 90;
	
	      if (this.elements.x < x) angle = angle + 180;
	    ...
	    key: "intersect",
	    value: function intersect(tower) {
	      return this.elements.x < tower.elements.x + tower.size && tower.elements.x < this.elements.x + this.size && this.elements.y < tower.elements.y + tower.size && tower.elements.y < this.elements.y + this.size;
	    }
	  }]);
...
/***/ function(module, exports) {
	...
	var Projectile = function () {
	  ...
	  _createClass(Projectile, [{
	    ...
	    value: function generateProjectile() {
	    ...
	    value: function adjustVector() {
	      ...
	      var targetX = this.target.elements.x;
	      var targetY = this.target.elements.y;
	      var projX = this.elements.x + 15;
	      var projY = this.elements.y + 15;
	
	      var distance = Math.hypot(targetX - projX, targetY - projY);
	    ...
	    value: function getAngle() {
	      ...
	      if (projX > targetX) angle = angle + 180;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ToolBox = function () {
	  function ToolBox() {
	    var handles = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : defaultHandles;
	
	    _classCallCheck(this, ToolBox);
	
	    this.elements = new createjs.Container();
	
	    this.handles = (0, _lodash.merge)(defaultHandles, handles);
	  ...
	  _createClass(Field, [{
	    ...
	    value: function rotateTurrets() {
	      ...
	      this.towers.forEach(function (tower) {
	        tower.targetMinion(Object.values(_this.minions));
	      });
	    }
	  }, {
	    key: "moveMinions",
	    ...
	    key: "updateVirtualBoard",
	    value: function updateVirtualBoard(x, y) {
	    ...
	    key: "cursorToFieldPos",
	    value: function cursorToFieldPos(x, y) {
	      x -= 8;
	      y -= 8;

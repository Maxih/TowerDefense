	...
	var Board = function () {
	  ...
	  _createClass(Board, [{
	    ...
	    value: function addMinions() {
	      var minion = new _minion2.default({ height: 15, width: 15 });
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Tower = function (_GameObject) {
	  ...
	  function Tower(size, createProjectile) {
	    ...
	    _this.elements = new createjs.Container();
	    ...
	    _this.elements.mouseChildren = false;
	
	    _this.elements.on("mouseover", _this.revealRadius.bind(_this));
	    _this.elements.on("mouseout", _this.hideRadius.bind(_this));
	
	    _this.elements.addChild(ghost, radius);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Minion = function (_GameObject) {
	  ...
	  function Minion(options) {
	    ...
	    var _this = _possibleConstructorReturn(this, (Minion.__proto__ || Object.getPrototypeOf(Minion)).call(this, options));
	  ...
	  _createClass(Minion, [{
	    ...
	    value: function moveMinion() {
	      var minionCoord = this.fieldToGrid();
	      var target = this.path.getPathToCoord(minionCoord.x, minionCoord.y, 15, 31);
